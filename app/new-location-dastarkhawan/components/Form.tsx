...
const schema = z.object({
  name: z.string().min(1, { message: "Please add location name!" }),
  tehsilId: z
  ...
  const onSubmit = async (formData: UpdateLocationInput) => {
    try {
      ...
      const res = await apiClient.post(
        DASTARKHAWN_API + "/add-new-location-details",
        updatedFormData,
      );
      console.log("res", res);
    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Flex justify="center">
          ...
          >
            Add Location {isSubmitting && <Spinner />}
          </Button>
        </Flex>
      </form>
      ...
      <Flex justify="end" className="pe-3">
        <Link
          href="/update-location-dastarkhawan"
